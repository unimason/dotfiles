...
**Stack**: Ghostty · Fish · Starship 　**Theme**: Ghostty Solarized Light · Starship Catppuccin Mocha · fzf Latte
...
| 维度 | 方案 | 理由 |
|---|---|---|
| 主题分层 | Ghostty Solarized Light 底色 + starship Mocha pastel 色块 + fzf Latte | 浅底上用 Mocha 的柔和 pastel 做分段视觉点缀 |
